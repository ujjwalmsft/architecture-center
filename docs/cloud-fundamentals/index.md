                ...
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            ...
                            <p>A catalog of design patterns for developers and solution architects. Each pattern describes a problem, a pattern that addresses the problem, and an example based on Azure.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<ul class="panelContent cardsI">
    <!-- Microservices -->
    <li>
        <a href="/azure/architecture/cloud-fundamentals/microservices">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        <div class="cardImageOuter">
    ...
    <li>
        <a href="/azure/architecture/cloud-fundamentals/multitenant-identity">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        <div class="cardImageOuter">
